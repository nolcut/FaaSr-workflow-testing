...
def run_pyadm1(folder, influent_file="digester_influent.csv",
    ...
    global influent_state, initial_state, S_su, S_aa, S_fa, S_va, S_bu, \
        ...
        pH, S_H_ion, S_va_ion, S_bu_ion, S_pro_ion, S_ac_ion, S_hco3_ion, \
        S_nh3, S_nh4_ion, S_co2, S_gas_h2, S_gas_ch4, S_gas_co2, K_pH_aa, \
        nn_aa, K_pH_ac, n_ac, K_pH_h2, n_h2, q_ad, state_zero, state_input, \
        t, simulate_results, columns, solvermethod, t0, n, initflow, \
        gasflow, total_ch4, initq, feedflow, u, tstep, sim_S_su, sim_S_aa, \
        sim_S_fa, sim_S_va, sim_S_bu, sim_S_pro, sim_S_ac, sim_S_h2, \
        sim_S_ch4, sim_S_IC, sim_S_IN, sim_S_I, sim_X_xc, sim_X_ch, \
        sim_X_pr, sim_X_li, sim_X_su, sim_X_aa, sim_X_fa, sim_X_c4, \
        sim_X_pro, sim_X_ac, sim_X_h2, sim_X_I, sim_S_cation, sim_S_anion, \
        sim_S_H_ion, sim_S_va_ion, sim_S_bu_ion, sim_S_pro_ion, \
        sim_S_ac_ion, sim_S_hco3_ion, sim_S_co2, sim_S_nh3, sim_S_nh4_ion, \
        sim_S_gas_h2, sim_S_gas_ch4, sim_S_gas_co2, p_gas_h2, p_gas_ch4, \
        p_gas_co2, p_gas, q_gas, q_ch4, flowtemp, dfstate_zero, phlogarray
    ...
    faasr_log("run_pyadm1: executing PyADM1 simulation")
