...
def run_adm1_model(influent_csv_path, initial_csv_path, output_csv_path):
  ...
  global S_H_ion, S_va_ion, S_bu_ion, S_pro_ion, S_ac_ion, S_hco3_ion
  global S_nh3, S_nh4_ion, S_co2, S_gas_h2, S_gas_ch4, S_gas_co2, pH
  global state_zero, state_input, q_ad
...
def pyadm1(folder: str, input1: str, input2: str, output1: str) -> None:
    ...
    faasr_log(f"pyadm1: wrote {output1}")
